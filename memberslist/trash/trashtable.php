      ...
      <nav id="sidebar" class="order-last" class="img" style="background-image: url(../images/bg_1.jpg);">
        ...
        <div class="">
          ...
          <li class="active">
            ...
            <li class="active">
              <a href="../trash.php"><span class="fas fa-trash mr-3"></span> Trash</a>
            </li>

            <li>
              <a href="../../logout.php"><span class="fas fa-sign-out-alt mr-3"></span> Log-out</a>
            </li>
          </ul>
...
echo '<td>' . $row['reasondisapproval'] . '</td>';    
echo '<td>' . $row['type'] . '</td>';        
echo '<td>' . $row['date_join'] . '</td>';    
echo '<td>' . $row['status'] . '</td>';
echo '<td>
            <a title="Delete Permanently"href="delete.php?id='.$row['id'].'">
