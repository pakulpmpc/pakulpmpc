    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="">
          ...
          <li class="active">
            ...
            <li class="active">
             ...
             <li class="active">
              <a href="../charts/seminarcharts.php"><span class="fas fa-bar-chart mr-3"></span> View Reports Here</a>
            </li>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <p><span class="fa fa-clock-o mr-3"></span> 8:00 AM - 5:00 PM</p>
         ...
         <p><span class=" fa-facebook-square mr-3"></span> Pakul Primary Multi-Purpose Cooperative</p>
...
<div class="container">
            ...
            foreach ($pdo->query($sql) as $row) {
              ...
              echo '<td>'.'
              <a title="Edit Seminar" href="editseminar.php?id='.$row['id'].'">
              <span class="fa fa-edit "></span></a>'.'<a title="Approve" href="editapprove.php?id='.$row['id'].'">
              <span class="fa fa-thumbs-up "></span></a>'.'
                         
                          <a title="Disapprove" href="editdecline.php?id='.$row['id'].'">
              <span class="fa fa-thumbs-down " aria-hidden="true"></span></a>
              </td>';  
              echo '</td>';
              echo '</tr>';
              echo '</td>';
