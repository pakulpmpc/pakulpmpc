      ...
      <nav id="sidebar" class="order-last" class="img" style="background-image: url(images/bg_1.jpg);">
        ...
        <div class="">
          ...
          <li class="active">
            ...
            <li class="active">
              <a href="usertable.php"><span class="fas fa-user-plus mr-3"></span> User Registration Table</a>
            </li>
            
            <li class="active">
              <a href="userapprove.php"><span class="fas fa-user-check mr-3"></span> Approved User Table</a>
            </li>
            <li class="active">
              <a href="addmin.php"><span class="fas fa-user mr-3"></span> Add Admin</a>
            </li>

            <li class="active">
              <a href="trashapp.php"><span class="fas fa-trash mr-3"></span> Trash</a>
            </li>
...
<div class="container">
                        ...
                        <h3 align="center"><h2>People who ask for creation of an<b> Account</b></h2>
			<br />
...
$sql = 'SELECT * FROM `userask` WHERE 1';
foreach ($pdo->query($sql) as $row) {
echo '<tr>';
echo '<td>' . $row['tinid'] . '</td>';  
...
echo '<td>'.'<a href="editapprove.php?id='.$row['id'].'">
<span class="fa fa-thumbs-up mr-2"></span></a>'.'
            <a href="editdecline.php?id='.$row['id'].'">
<span class="fa fa-thumbs-down mr-2" aria-hidden="true"></span></a></td>';  
echo '</td>';
echo '</tr>'; 
}
Database::disconnect(); 
