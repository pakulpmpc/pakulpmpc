...
<html lang="en">
  ...
  <link rel="icon" type="image/x-icon" href="../../userpage/assets/pakul.jpg" />
    ...
    <title>ADMIN | APPROVED USER TABLE</title>
    <meta charset="utf-8">
...
<div class="container">
                        ...
                        <h3 align="center"><h2>Approve User<b> List</b></h2>
			<br />
...
<span class="fa fa-thumbs-up ml-3 mr-2"></span></a>'.'
            <a href="trashapp.php?id='.$row['id'].'">
<span class="fa fa-thumbs-down ml-3 mr-2" aria-hidden="true"></span></a></td>';  
echo '</td>';
echo '</tr>'; 
}
Database::disconnect(); 
